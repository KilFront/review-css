var standards = [{
  ...
  "url": "https://www.w3.org/TR/2021/WD-css-multicol-1-20210212/"
}, {
  ...
  "url": "https://www.w3.org/TR/2021/WD-css-cascade-5-20210119/"
}, {
...
// 偷懒方法，在W3C网站上，找一个幸运的页面，然后把它改造成我们的爬虫页面，这样不需要处理跨域问题
...
void async function() {
  for(let standard of standards) {
    ...
    // 等待iframe load事件
    await happen(iframe, 'load'); // 后续爬不同页面里的不同内容; 如果怕影响访问w3c网站，可以加一个延迟
